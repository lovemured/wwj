...
export declare class AdbScrcpyOptions2_3<TVideo extends boolean> extends ScrcpyOptions2_3<TVideo> implements AdbScrcpyOptions<ScrcpyOptions2_3.Init<TVideo>>, AdbScrcpyOptionsGetEncoders {
    readonly version: string;
    readonly spawner: AdbNoneProtocolSpawner | undefined;
    constructor(init: ScrcpyOptions2_3.Init<TVideo>, clientOptions?: AdbScrcpyClientOptions);
    getEncoders(adb: Adb, path: string): Promise<ScrcpyEncoder[]>;
    getDisplays(adb: Adb, path: string): Promise<ScrcpyDisplay[]>;
    createConnection(adb: Adb): AdbScrcpyConnection;
}
export declare namespace AdbScrcpyOptions2_3 {
    type Init<TVideo extends boolean = boolean> = ScrcpyOptions2_3.Init<TVideo>;
}
