...
import type { ScrcpyControlMessageType, ScrcpyDisplay, ScrcpyMediaStreamPacket, ScrcpyOptions, ScrcpyScrollController, ScrcpyVideoStream } from "../base/index.js";
...
export declare class ScrcpyOptions1_15 implements ScrcpyOptions<Init> {
    #private;
...
type Init_ = Init;
export declare namespace ScrcpyOptions1_15 {
    type Init = Init_;
}
export {};
