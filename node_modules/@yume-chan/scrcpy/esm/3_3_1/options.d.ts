...
export declare class ScrcpyOptions3_3_1<TVideo extends boolean> implements ScrcpyOptions<Init<TVideo>>, ScrcpyOptionsListEncoders {
    #private;
...
export declare namespace ScrcpyOptions3_3_1 {
