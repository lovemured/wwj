...
export declare class ScrcpyOptions2_7<TVideo extends boolean> implements ScrcpyOptions<Init<TVideo>>, ScrcpyOptionsListEncoders {
    #private;
...
export declare namespace ScrcpyOptions2_7 {
