...
export declare class ScrcpyOptions3_1<TVideo extends boolean> implements ScrcpyOptions<Init<TVideo>>, ScrcpyOptionsListEncoders {
    #private;
...
export declare namespace ScrcpyOptions3_1 {
