...
export declare class ScrcpyOptions2_1<TVideo extends boolean> implements ScrcpyOptions<Init<TVideo>>, ScrcpyOptionsListEncoders {
    #private;
...
export declare namespace ScrcpyOptions2_1 {
