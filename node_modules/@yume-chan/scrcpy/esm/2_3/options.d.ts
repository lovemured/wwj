...
export declare class ScrcpyOptions2_3<TVideo extends boolean> implements ScrcpyOptions<Init<TVideo>>, ScrcpyOptionsListEncoders {
    #private;
...
export declare namespace ScrcpyOptions2_3 {
