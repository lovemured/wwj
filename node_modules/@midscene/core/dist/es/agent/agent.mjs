...
class Agent {
    ...
    async aiAct(taskPrompt, opt) {
        ...
        const runAiAct = async ()=>{
            ...
            const noIndividualLocateModel = 'default' === modelConfigForPlanning.slot;
            ...
            const { output: actionOutput } = await this.taskExecutor.action(taskPrompt, modelConfigForPlanning, this.modelConfigManager.getModelConfig('default'), includeBboxInPlanning, this.aiActContext, cacheable, replanningCycleLimit, imagesIncludeCount, deepThink, fileChooserAccept, deepLocate, abortSignal);
